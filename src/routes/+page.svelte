...
<Window title="Welcome to berryOS" isOpen={apps.welcome} onClose={() => (apps.welcome = false)}>
	...
	<h2 class="text-[#f5c2e7] text-xl font-bold">User Profile: Developer & Gamer</h2>
	<p class="mt-2 text-white/80"><strong>Core Languages:</strong> Go, C#, and C++</p>
</Window>

<Window title="Hacker Notes" isOpen={apps.notes} onClose={() => (apps.notes = false)}>
	<h1 class="text-[#f5c2e7] text-3xl font-bold border-b-2 border-[#f5c2e7] pb-2 w-full">Notes</h1>
	<hr class="border-0 border-t border-[#45475a] my-5" />
...
<div class="absolute bottom-3 left-0 w-full flex justify-center pointer-events-none z-2000">
	<div
